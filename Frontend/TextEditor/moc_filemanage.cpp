...
QT_MOC_LITERAL(1, 4, 12), // "createNewTab"
...
QT_MOC_LITERAL(4, 30, 6), // "QFile*"
QT_MOC_LITERAL(5, 37, 1) // "f"

    },
    "FileManage\0openFile\0\0SaveFile\0QFile*\0"
    "f"
};
#undef QT_MOC_LITERAL
...
void FileManage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->SaveFile((*reinterpret_cast< QFile*(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::RegisterMethodArgumentMetaType) {
        switch (_id) {
