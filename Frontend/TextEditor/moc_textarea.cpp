...
QT_MOC_LITERAL(3, 19, 8) // "SaveFile"

    },
    "TextArea\0OpenFile\0\0SaveFile"
};
...
void TextArea::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<TextArea *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject TextArea::staticMetaObject = { {
    QMetaObject::SuperData::link<QPlainTextEdit::staticMetaObject>(),
    qt_meta_stringdata_TextArea.data,
    qt_meta_data_TextArea,
    qt_static_metacall,
    nullptr,
    nullptr
} };
